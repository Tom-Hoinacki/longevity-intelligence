...
- `workflow.claim_candidates` stores structured, versioned model output and deterministic validation results. Proposed scores are constrained to 0 through 5 but are candidates, not scientific certainty.
