...
public sealed class DemoPublicEvidenceCatalog : IPublicEvidenceCatalog
{
    ...
    private static readonly PublicEvidenceClaim Claim = new(ClaimId, AssetId, "Illustrative demo claim for interface development.", "demo", null, null, null, null, null, null, 1, [new(Guid.Parse("44444444-4444-4444-4444-444444444444"), SourceId, "unknown", "illustrative", null, null, null, "Demo data is not evidence.", null, Source)]);
